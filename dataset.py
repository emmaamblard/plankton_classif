...
class EcoTaxaGenerator(utils.Sequence):
    ...
    Args:
        ...
        features_lists (list/ndarray, float): features associated with images
    ...
    def augmenter(self, images):
        ...
        vertical flip (50% chance), rotation, zoom and shear
        """
        seq = iaa.Sequential(
            [
    ...
    def __getitem__(self, index):
        ...
        for i,img in enumerate(batch_orig_images):
